      ...
      <div className={styles.menu_container}>
        ...
        <div className={styles.menu_section}>
          ...
          <div className={styles.menu_items}>
            ...
            <div className={styles.menu_item}>
              <img src="https://via.placeholder.com/120" alt="Yogurt Parfait" />
              <div className={styles.item_info}>
        ...
        <div className={styles.menu_section}>
          ...
          <div className={styles.menu_items}>
            <div className={styles.menu_item}>
              <img src="https://via.placeholder.com/120" alt="Cheese Burger" />
              <div className={styles.item_info}>
                <h3>Cheese Burger</h3>
            ...
            <div className={styles.menu_item}>
              <img src="https://via.placeholder.com/120" alt="Club Sandwich" />
              <div className={styles.item_info}>
                <h3>Club Sandwich</h3>
        ...
        <div className={styles.menu_section}>
          ...
          <div className={styles.menu_items}>
            ...
            <div className={styles.menu_item}>
              <img src="https://via.placeholder.com/120" alt="Chicken Wings" />
              <div className={styles.item_info}>
                <h3>Chicken Wings</h3>
            ...
            <div className={styles.menu_item}>
              <img src="https://via.placeholder.com/120" alt="Cheese Sticks" />
              <div className={styles.item_info}>
                <h3>Cheese Sticks</h3>
